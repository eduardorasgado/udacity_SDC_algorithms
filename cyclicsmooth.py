...
path1 = smooth(testpath1)
path2 = smooth(testpath2)
x1 = []
x2= []
y1 = []
y2 = []
...
for i in range(len(path2)):
    x3.append(testpath2[i][0])
    y3.append(testpath2[i][1])
    
plt.plot(x1,y1,'r--',label="path 1")
plt.plot(x2,y2,'c--',label="path 2")
plt.plot(x3,y3,'b-',label="path 2 original")
plt.legend(loc=4)
plt.show()